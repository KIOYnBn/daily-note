...
- frame
	- frame sth斟酌语言、表达 / 陈述某事 
		- frame your words斟酌措辞
		- She framed her words politely
		- frame an opinion / argument阐述观点、表达论点
	- frame sth as…把… 表述为 / 定性为… 
		- frame sth as a problem/challenge把某事定性 / 表述为难题
...
- Substitute: substitute sth.(old) for sth.(new)
	...
	- e.g. They are subtituting violence for dialogue
#### 不乏
- have no shortage of
	- e.g. Her obituary had no shortage of adjectives about her striking appearance
---
## 观点
- take a position on sth： 持某种观点
	- take a positive/negative position on sth
---
## 我们如何做
### 努力做
- endeavor to do
...
- arrange
- organize(更正式)
	- He is organizing a competition based on Civiliization Ⅵ
### 弄懂
